          ...
          <div class="modal-content">
            <div class="">
              ...
              <span  class="modal-title font-weight-bold text-center" id="exampleModalLongTitle">
                <span style="font-size: 20px;">Welcome <span style="color:#207ce5">
                <?php echo $user->name; ?></span>  </span>  
              </span>
              </div>
            </div>
            <div class="modal-body">
              ...
              <p>This is Twitter clone made by <span style="font-weight: 700;">Jouse Márquez
            </span> for learning purpose.</p>
              <p>By Signing Up then you followed
                <a style="color:#207ce5;" href="jouse">@jousemarquez</a> 
        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <a href="home.php"><img src="assets/images/favicon.png" alt="" height="30px" width="30px" /></a>
            </div>
          </div>
          ...
          <div class="grid-sidebar">
            ...
            <div class="wrapper-left-elements">
              <a href="#" style="margin-top: 4px"><strong>Notification</strong></a>
            </div>
          </div>
          </a>
