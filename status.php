...
?>
          ...
          <div class="box-tweet feed" style="position: relative;" >
            ...
            <a style="position: relative; z-index:100; color:rgb(102, 117, 130);" href="<?php echo $retweeted_user->name; ?> "> <?php if ($retweeted_user->id == $user_id) {
    echo "You";
} else {
    echo $retweeted_user->name;
}
    ?> </a>  retweeted</span>
             <?php }?>
